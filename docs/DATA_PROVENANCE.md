...
|---|---|---|---|---|
| University S3 YouTube crawl | Persian acoustics/captions; conversation candidates | Supervisor-approved internal thesis training; source licenses not independently verified | No | Final measured selection: 309 episodes / 1,129 windows / 219.946 candidate h / 244.733 staging h; 207.154 automatic multi-speaker h, 242.445 aligned h, and 6,754 non-reused response pairs / 123.796 source-pair h. The immutable Piper derivative is 6,754/6,754 pairs / 108.584 final stereo h; its independent machine audit has zero failures and 24/24 exact assistant re-syntheses. All 1,129 windows are internally authorized. The 40-row window QA and preserved 24-row interaction QA are waived—not completed—for the active limited run; zero interactions are represented as human-verified. |
