...
- The measured production selection has **219.946 candidate h / 309 episodes**, **207.154 automatic multi-speaker h**, **242.445 aligned staging h**, and **6,754 non-reused response pairs / 123.796 source-pair h**. The completed immutable Piper derivative is **6,754 pairs / 108.584 final stereo h** and its independent machine audit passes. Please confirm whether this final exported duration is the binding 100–200-hour measure.
...
- The conservative caption labels leave 5,411 pairs as `overlap_unattributed`, but retained raw speaker boundaries recover **770 strict automatic candidates** (717 interruption-like / 53 backchannel-like). The preserved 24-row sheet was sampled from the earlier 712-candidate pool, six per channel, and contains only **168.3 seconds** of excerpt audio. Is that pair-level listening sample sufficient, what minimum precision/acceptance threshold should apply, and may passing reviewed archive pairs satisfy interruption supervision without new recording?
...
“The internal archive-training approval is recorded. The completed immutable corpus has 6,754 pairs / 108.584 final stereo hours and passes its independent machine audit. Raw speaker boundaries recover 770 automatic interaction candidates; the preserved four-channel pair review is only 24 rows / 168.3 seconds and was sampled before the reserve expansion. Please confirm that final exported duration is the binding 100–200-hour measure, whether the 40-row window QA and this pair-level QA are sufficient, and the required candidate-precision threshold. I also need decisions on feature/metrics-only human sessions, the 500 ms statistic, RTX 4090 target evaluation, and the pinned Moshika + official Moshi-Finetune path.”
