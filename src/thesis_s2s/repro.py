...
SNAPSHOT_FILES = (
    ...
    "configs/application_dependency_risk_policy.json",
    "configs/frozen_evaluator_sources.json",
    ...
    "results/hardware/storage_cleanup_20260909.json",
    ...
    "results/security/application_dependency_audit.json",
    "results/model_selection_audit.json",
    "results/proposal_alignment_audit.json",
    "results/conversation_balance_audit.json",
    "results/conversation_balance_v2_plan.json",
    "results/conversation_balance_v2_initial_yield.json",
    "results/conversation_balance_v2_noise_report.json",
    "results/conversation_balance_v2_rights_report.json",
    "results/conversation_balance_v2_extension_prepared_audit.json",
    "results/conversation_balance_v2_extension_yield.json",
    "results/conversation_balance_v2_extension_noise_report.json",
    "results/conversation_balance_v2_extension_rights_report.json",
    "results/conversation_balance_v2_pair_merge.json",
    "results/conversation_balance_v2_selection.json",
    ...
    "results/moshi_validation_reevaluation.json",
    "results/moshi_adapter_validation.json",
    "results/moshi_heldout_model_eval.json",
    ...
    "results/hardware/moshi_v3_preflight.json",
    "results/hardware/moshi_h100_v3_profile_probe.json",
    "results/hardware/moshi_v3_validation_pipeline.json",
    ...
    "docs/RESPONDER_LORA_PROTOCOL.md",
    "docs/QWEN4B_CASCADE_PROTOCOL.md",
    "docs/QWEN4B_CASCADE_V2_PROTOCOL.md",
    "results/training/responder_lora_v1_attempt1_failed.json",
    "results/training/responder_lora_v1.json",
    "results/eval/cascade_semantic_proxy.json",
    "results/eval/responder_lora_semantic_proxy.json",
    "results/eval/qwen4b_responder_semantic_proxy.json",
    "results/eval/qwen4b_responder_v2_development_proxy.json",
    "results/eval/qwen4b_responder_v2_final_test_proxy.json",
    "results/eval/responder_candidates_v1_plan.json",
    "results/eval/responder_candidates_v1_development.json",
    "results/eval/asr_candidates_v1_plan_attempt1.json",
    ...
    "results/eval/asr_shenava_supplemental_v1_plan.json",
    "results/eval/asr_shenava_supplemental_v1_screen.json",
    "results/eval/frozen_evaluator_source_verification.json",
