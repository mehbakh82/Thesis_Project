...
def test_v4_protocol_requires_its_own_pretraining_freeze_marker() -> None:
    runtime = {
        "protocol_predeclared_before_training": True,
        "protocol": {
            "complete_user_turn_required": True,
    ...
    assert runtime_protocol_valid(runtime, "predeclared-v4") is True
    runtime["protocol_provenance"] = {
        **runtime["protocol_provenance"],
        "frozen_before_v4_optimizer_step": False,
        "frozen_before_v3_optimizer_step": True,
    }
